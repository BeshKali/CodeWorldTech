...
const projects = [
  {
    ...
    stack: ["React", "Node.js", "M-Pesa API", "Firebase Auth", "MongoDB"],
  ...
  },
  {
    title: "CareConnect",
    id: "SYS_HEALTH_002",
    desc: "A youth centric telemedicine system especially made for the Tvet institutions and Universities to curb the Issue of OTC drugs.",
    stack: ["React", "Node.js", "ws-signal", "MongoDB", "Firebase Auth"],
